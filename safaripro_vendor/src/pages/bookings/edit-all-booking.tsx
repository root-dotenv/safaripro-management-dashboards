// safaripro_admin/src/pages/bookings/edit-all-booking.tsx
...
import {
  ...
  FaTags,
  FaFileAlt,
  FaBuilding, // Added for Hotel Name read-only field
} from "react-icons/fa";
import { IoChevronBackOutline, IoChevronForwardOutline } from "react-icons/io5";

import type { Booking } from "./booking-types";

// Define the shape of the form data for editing (using strings for inputs)
...
export default function EditAllBookingPage() {
  ...
  const updateBookingMutation = useMutation({
    mutationFn: async (updatedData: Partial<BookingFormData>) => {
      const payload = {
        ...
        // Include non-editable fields from original data to ensure they are not lost if PATCH requires them
    ...
    onSuccess: () => {
      ...
      navigate("/bookings/all-bookings"); // Navigate back to the All Bookings list
    },
    onError: (error: any) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                value={
                  formData.checkin
                    ? formData.checkin.slice(0, 16) // Format for datetime-local input
                    : ""
                }
                onChange={handleInputChange}
                className="w-full p-2 border border-[#E8E8E8] rounded-md focus:ring-[#553ED0] focus:border-[#553ED0] bg-[#F8FAFC] text-[#202020]"
            ...
            <div>
              ...
              <input
                ...
                value={
                  formData.checkout
                    ? formData.checkout.slice(0, 16) // Format for datetime-local input
                    : ""
                }
                onChange={handleInputChange}
                className="w-full p-2 border border-[#E8E8E8] rounded-md focus:ring-[#553ED0] focus:border-[#553ED0] bg-[#F8FAFC] text-[#202020]"
